...
\usepackage{rotating} % Поворот текста в таблицах
...
\hypersetup{
    ...
    pdfauthor={Халиков Александр},
    pdftitle={Разработка однопроцессорного и двухпроцессорного модулей на базе микропроцессора «Эльбрус-8С2» для серверов}
}
